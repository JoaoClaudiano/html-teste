...
├── google8df277a1c3c466cf.html # Verificação Google
├── css/
│ └── styles.css # Estilos principais
├── js/
│ └── analyze.js # Funções de análise
└── erros/ # Exemplos de erros comuns
├── img-sem-alt.html
├── title-ausente.html
...
W3C pelos padrões HTML

Testadores que reportam issues
